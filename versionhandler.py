...
class VersionHandler:
    ...
    def export_file(self, ver, uid, sha, msg):
        ...
        with open(VERSIONFILE, 'w+') as f:
            f.write(literal.format(ver, uid, sha, msg))
    ...
    def handle_true_case(self):
        ...
        self.export_file(ver=version, uid=UUID, sha=sha, msg=message)
        return {
            '__version__': version,
            'UUID': UUID,
            'sha': sha,
