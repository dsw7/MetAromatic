...
def get_relevant_met_coordinates(first_model, chain):
    return [line.split()[:9] for line in first_model if match(rp.pattern_regex_met(chain), line)]

def get_relevant_phe_coordinates(first_model, chain):
    return [line.split()[:9] for line in first_model if match(rp.pattern_regex_phe(chain), line)]

def get_relevant_tyr_coordinates(first_model, chain):
    return [line.split()[:9] for line in first_model if match(rp.pattern_regex_tyr(chain), line)]

def get_relevant_trp_coordinates(first_model, chain):
    return [line.split()[:9] for line in first_model if match(rp.pattern_regex_trp(chain), line)]
