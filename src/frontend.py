...
def get_command_line_arguments():
    ...
    parser.add_argument('--host', help=help_messages.MSG_HOST, default='localhost')
    parser.add_argument('--port', help=help_messages.MSG_PORT, default=27017, type=int)
    parser.add_argument('--database', help=help_messages.MSG_DB, default='foobar')
    parser.add_argument('--collection', help=help_messages.MSG_COL, default='hamspam')
