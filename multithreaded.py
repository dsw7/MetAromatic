...
class RunBatchJob:
    def __init__(
            self, batch_file, num_threads=30,
            cutoff_distance=4.9, cutoff_angle=109.5, chain='A',
            model='cp', database='foobar', collection='hamspam'
        ):
        ...
        self.chain = chain
        self.model = model
        self.collection = MongoClient(host='localhost', port=27017)[database][collection]
